// Using localStorage to store user and computer scores we use localstorage.
...
// Setting data for rock, paper and  scissor option;
const data = {
  rock: {
    winning: "scissor",
    losing: "paper",
...
// // An array to hold possible computer choices
const pcChoiceArray = ["rock", "paper", "scissor"]
// Function to check the winner between user and computer
...
// HTML template for the initial game page
const mainpageTxt = () => {
...
//HTML template for the end page (when the user wins)
const endPageTxt = `    <div class="main-body">
      <div class="img-container">
        <img src="prize-icon.svg" alt="Prize" class="prize" />
        <img src="star-icon.svg" alt="Star" class="star-1" />
        <img src="star-icon.svg" alt="Star" class="star-2" />
        <img src="star-icon.svg" alt="Star" class="star-3" />
        <img src="star-icon.svg" alt="Star" class="star-4" />
        <img src="star-icon.svg" alt="Star" class="star-5" />
        <img src="star-icon.svg" alt="Star" class="star-6" />
        <img src="star-icon.svg" alt="Star" class="star-7" />
        <img src="star-icon.svg" alt="Star" class="star-8" />
      </div>
      <div class="won-end">
        <h2>Hurray!!</h2>
...
const optionTxt = `<div class="main-container page-1">
          <div class="choose-option">
            <div class="options-bg">
              <img src="Sanket_triangle.svg" alt="" />
            </div>
...
//show popup when user touch rules button
...
//buttons that shows playagain,reset,next
...
// Rendering functions
//Function to render the initial game page
...
// Function to render the initial game page after a win
...
// Function to handle the next winner or reset the game after a win
...
// Handling the "Play Again" button click on the results page
  if (e.target.classList.contains("reset-btn")) {
    resetRender()
  }
 // Handling the "Next" button click on the results page 
  if (e.target.classList.contains("next-btn")) {
    nextWinner(winnerCheck)
  }
  // Handling the "Play Again" button click on the end page
